...
link:/#/https://github.com/asciidoctor/asciidoctor.org/blob/master/docs/_includes/asciidoc-article-template.adoc[Click here to open an AsciiDoc article template]
